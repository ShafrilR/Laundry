...
export default class Transaksi extends React.Component{
    ...
    saveDetail = event => {
        ...
        .catch(error => console.log(error))
        $("#modal_up").modal("hide")
        this.props.history.push("/transaksiK")
    }
            ...
            <div>
                ...
                <div ref={target} id="target" className="container" style={{width: 1050}}>
                    ...
                    <div class="btn-group" role="group">
                        <button className="btn btn-info" onClick={() => this.Add()}>Transaksi Baru</button>
                        <button className="btn btn-outline-info" onClick={() => this.convertPdf()}>
                         ...
                         <div className="modal-content">
                             ...
                             <div className="modal-body">
                                    <label>Nama Member</label>
                                     ...
                                     <select class="form-control mb-1" value={this.state.id_member} 
                                    onChange={ev => this.setState({id_member: ev.target.value})} required>
                                        <option value="">
                                            Pilih Opsi
                                        </option>
                                    ...
                                    <label>ID User</label>
                                    <div className="form-group was-validated">
                                    <select class="form-control mb-1" value={this.state.id_user} 
                                    onChange={ev => this.setState({id_user: ev.target.value})} required>
                                        <option value="">
                                            Pilih Opsi
                                        </option>
                 ...
                 <div className="modal fade" id="modal_detail">
                     <div className="modal-dialog modal-dialog-centered">
                         <div className="modal-content">
                             ...
                             <div className="modal-footer">
                                <button className="btn btn-outline-info" onClick={() => this.Up()}>
                                    Update Detail
                                </button>
                            </div>      
                         </div>
